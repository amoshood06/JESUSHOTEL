...
$sql = "SELECT * FROM food_menu WHERE availability = 1";
$params = [];
...
<section class="py-12 bg-gray-50">
    <div class="container mx-auto px-4 lg:px-8">
        <h1 class="text-3xl font-bold text-gray-800 mb-8 text-center">Our Food & Drink Menu</h1>
        ...
        <?php if (empty($food_items)): ?>
            <p class="text-center text-gray-600 text-lg">No food or drink items available matching your filters. Please adjust your criteria.</p>
        <?php else: ?>
