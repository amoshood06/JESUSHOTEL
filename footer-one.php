...
<a href="cart.php" 
   target="_blank" 
   class="whatsapp-bounce fixed bottom-6 right-6 z-[9999] flex items-center justify-center w-14 h-14 bg-[#D48255] rounded-full shadow-2xl transition-all active:scale-95 group"
   title="Chat with us">
  <svg class="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
