    <!-- Footer -->
    <footer class="bg-teal-600 text-white pt-16 pb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                ...
                <div class="space-y-4">
                    ...
                    <p class="text-white/80 text-sm leading-relaxed">
                        Your gateway to affordable comfort and everyday luxury in the heart of Okada.
                    </p>
                ...
                <div>
                    ...
                    <p class="text-sm text-white/80 mb-4">Subscribe to get special offers and updates</p>
                    <div class="space-y-3">
                        <input type="email" placeholder="Your email address" class="w-full px-4 py-2 rounded-lg bg-white/10 border border-white/20 text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-white/50">
                        <button class="w-full bg-white text-teal-600 px-4 py-2 rounded-lg hover:bg-gray-100 transition-colors font-semibold">
                            Subscribe
                        </button>
                    </div>
                    <div class="flex gap-3 mt-6">
                        <a href="https://web.facebook.com/people/Avilla-Okada/61585139773672/?_rdc=1&_rdr#" class="h-10 w-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors">
